...
namespace Weather
{
    ...
    public class CurrentObservationResponse
    {
        public string version { get; set; }
        public string termsofService { get; set; }
        public CurrentObservationFeatures features { get; set; }
    }
    ...
    public class CurrentObservationResults
    {
        public CurrentObservationResponse response { get; set; }
